                                        ...
                                        <form >
                                            <div className="signup-form">
                                                <div style={{ position: 'relative' }}>
                                                    <label className="email-label" htmlFor="emal1"><img src={emailico} alt="" /></label>
                                                    <input className="input-1-new" type="email" onClick={(e) => this.setState({ email1: e.target.value })} name="" id="email1" placeholder="Email" required />
                                                </div>
                                                <div style={{ position: 'relative', marginTop: 20 }}>
                                                    ...
                                                    <input onClick={(e) => this.setState({ password1: e.target.value })} className="input-1-new" type={this.state.passShow ? "text" : "password"} name="" id="pass1" placeholder="Password" required />
                                                </div>
                                                <div style={{ position: 'relative', marginTop: 20 }}>
                                                    <label className="email-label" htmlFor="pass1"><img src={lock} alt="" /></label>
                                                    ...
                                                    <input onClick={(e) => this.setState({ confirmPassowrd: e.target.value })} className="input-1-new" type="password" name="" id="pass1" placeholder="Confirm Password" required />
                                                </div>
                                                <div style={{ position: 'relative', marginTop: 20 }}>
                                                    <label className="email-label" htmlFor="pass1"><img src={lock} alt="" /></label>
                                                    {/* <label onMouseLeave={() => this.setState({ passShow1: false })} onMouseEnter={() => this.setState({ passShow: true })} className="eye-label" htmlFor="emal1"><img src={eye} alt="" /></label> */}
                                                    <input onClick={(e) => this.setState({ age: e.target.value })} className="input-1-new" type="number" name="" id="pass1" placeholder="Age" required />
                                                </div>
                                                <div className="remember-me">
                                                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column' }}>
                                                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                                            <input onClick={(e) => this.setState({ checked1: e.target.value })} className="checking m-1" type="checkbox" required name="" id="checking-1" />
                                                            <label htmlFor="checking-1" className="custom-checkbox" ></label>
                                                            <label htmlFor="checking-1" className="remember-heading m-1">I agree <label htmlFor="checking" className="remember-heading m-1" style={{ color: "#a10948" }}>that, I am 21 above</label> </label>
                                                        </div>
                                                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                                            <input onClick={(e) => this.setState({ checked2: e.target.value })} className="checking m-1" type="checkbox" required name="" id="checking-2" />
                                                            <label htmlFor="checking-2" className="custom-checkbox" ></label>
                                                            <label htmlFor="checking-2" className="remember-heading m-1">I agree <label htmlFor="checking" className="remember-heading m-1" style={{ color: "#a10948" }}> terms & conditions and Privacy policy</label> </label>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    }
                    {
                        this.state.toggler1 === 1 ?
                            <>
                                ...
                                <form onSubmit={() => this.formhandler1} ani={this.state.toggler1} className="signup-menu">
                                    <div className="signup-form" style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-start', height: '60%', flexDirection: 'column' }}>
                                        <span className="signup-heading">Welcome to <span className="font" style={{ fontSize: 50 }}> Clink</span></span>
                                        <p className="signup-p" >Welcome back to clink sign in to place your<br />
                                        order.
                                        ...
                                        <div className="signup-form">
                                            <div style={{ position: 'relative' }}>
                                                ...
                                                <input onChange={(e) => this.setState({ email: e.target.value })} className="input-1-new" type="email" name="" id="email1" placeholder="Email" required />
                                            </div>
                                            <div style={{ position: 'relative', marginTop: 20 }}>
                                                <label className="email-label" htmlFor="pass1"><img src={lock} alt="" /></label>
                                                <label onMouseLeave={() => this.setState({ passShow: false })} onMouseEnter={() => this.setState({ passShow: true })} className="eye-label" htmlFor="emal1"><img src={eye} alt="" /></label>
                                                <input onChange={(e) => this.setState({ password: e.target.value })} className="input-1-new" type={this.state.passShow ? "text" : "password"} name="" id="pass1" placeholder="Password" required />
                                            </div>
                                            <div className="remember-me">
                                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                                    <input onChange={(e) => this.setState({ checked: e.target.checked })} className="checking m-1" type="checkbox" name="" id="checking" />

                                                    <label htmlFor="checking" className="custom-checkbox" ></label>
                                                    <label htmlFor="checking" className="remember-heading m-1">Remember Me</label>
                                            ...
                                            <div className="signup-btns">
                                                <button className="signupbtn btn-1-new" type="submit">Login</button>
                        ...
                        this.state.toggler === 1 ?
                            <>
                                <div ani={this.state.toggler} className="menu">
                                    <div>
                                        <li className="menu-li" style={{ cursor: 'pointer' }} onClick={() => window.location.href = "/Home"}>Home</li>
                                        <li className="menu-li" style={{ cursor: 'pointer' }} onClick={() => window.location.href = '/AboutUs'} >About</li>
                                        <li className="menu-li" style={{ cursor: 'pointer' }} onClick={() => window.location.href = '/Products'}  >Products</li>
                                        <li className="menu-li" style={{ cursor: 'pointer' }} onClick={() => window.location.href = '/BlogPage'} >Blog</li>
                                        <li className="menu-li" style={{ cursor: 'pointer' }} onClick={() => window.location.href = '/Shops'} >Contact</li>
